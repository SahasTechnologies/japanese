...
const ITEMS = [
  ...
  { id: 'vocab',     icon: '語', label: 'Vocabulary', desc: '330+ core words by category',             color: 'var(--green)' },
  ...
  { id: 'mock',      icon: '試', label: 'Mock Test',  desc: 'Timed mixed exam (15 q · 5 min)',        color: 'var(--red)' },
